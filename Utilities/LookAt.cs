...
namespace InspectorTween {
	public class LookAt : MonoBehaviour {
		...
		[Space(10)] public referenceSpace space;
		...
		[Header("Update Limiter")] public bool limitUpdate;
		public float targetFPS = 30;
		protected float nextRenderTime;
		[Header("OnVisible")] public bool updateOnlyWhenVisible;
		...
		Vector3 GetUpVector() {
			...
			switch ( space ) {
				case referenceSpace.parent:
					spaceT = this.transform.parent;
					break;
				case referenceSpace.root:
					spaceT = this.transform.root;
					break;
